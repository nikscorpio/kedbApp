package io.kedb.repository;

import io.kedb.KedbApp;
import io.kedb.config.Constants;
import io.kedb.config.audit.AuditEventConverter;
import io.kedb.domain.PersistentAuditEvent;
...
import static io.kedb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
